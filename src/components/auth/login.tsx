          ...
          <div className="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
            <div className="px-5 py-4">
              ...
              <button
                type="button"
                disabled={loading}
                className={`transition duration-200 bg-purple-600 ${
                  loading ? 'hover:bg-purple-300' : 'hover:bg-purple-700'
                } focus:bg-purple-800 focus:shadow-sm focus:ring-4 focus:ring-purple-500 focus:ring-opacity-50 ${
                  loading ? 'text-gray-300' : 'text-white'
                } w-full py-2.5 rounded-lg text-lg shadow-sm hover:shadow-md font-semibold text-center flex justify-center items-center`}
